...
public class InvitationsTest implements En {
    ...
    @Inject
    private ConfirmationLinkDAO confirmationLinkDao;
    ...
    private void nonExistingUserConfirmsEmailInvitation() {
        ...
        When("^I accept email link$", () -> {
            ...
            ConfirmationLinkRequestDTO cr = new ConfirmationLinkRequestDTO();
            confirmationLinkDao.confirmLink(uid, cr, accountDao, challengerDao);
        });
